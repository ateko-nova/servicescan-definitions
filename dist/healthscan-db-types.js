...
(function (EIssueType) {
  ...
  EIssueType[(EIssueType["DATABASE_LOOKUPS_IN_ACCESS_CONTROL_RULES"] = 8)] =
    "DATABASE_LOOKUPS_IN_ACCESS_CONTROL_RULES";
  EIssueType[(EIssueType["GLOBAL_BUSINESS_RULES"] = 9)] =
    "GLOBAL_BUSINESS_RULES";
  EIssueType[(EIssueType["INSTANCE_ERROR_LOGS"] = 10)] = "INSTANCE_ERROR_LOGS";
  EIssueType[(EIssueType["LONG_RUNNING_REPORTS"] = 11)] =
    "LONG_RUNNING_REPORTS";
  EIssueType[(EIssueType["DUPLICATE_SCRIPT_INCLUDES"] = 12)] =
    "DUPLICATE_SCRIPT_INCLUDES";
  EIssueType[(EIssueType["DUPLICATE_FIELDS"] = 13)] = "DUPLICATE_FIELDS";
  EIssueType[(EIssueType["SCRIPT_INCLUDE_REPORTS"] = 14)] =
    "SCRIPT_INCLUDE_REPORTS";
  EIssueType[(EIssueType["TOO_MANY_CHOICES"] = 15)] = "TOO_MANY_CHOICES";
  EIssueType[(EIssueType["ASYNC_AJAX_METHODS"] = 16)] = "ASYNC_AJAX_METHODS";
  EIssueType[(EIssueType["DUPLICATE_UPDATE_SETS"] = 17)] =
    "DUPLICATE_UPDATE_SETS";
  EIssueType[(EIssueType["INSERTS_IN_BUSINESS_RULES"] = 18)] =
    "INSERTS_IN_BUSINESS_RULES";
  EIssueType[(EIssueType["LAST_SYSTEM_UPGRADE"] = 19)] = "LAST_SYSTEM_UPGRADE";
  EIssueType[(EIssueType["REPORT_3_MONTHS"] = 20)] = "REPORT_3_MONTHS";
  EIssueType[(EIssueType["SCRIPT_INCLUDE_NO_ACL"] = 21)] =
    "SCRIPT_INCLUDE_NO_ACL";
  ...
  EIssueType[(EIssueType["SOFTWARE_ENTITLEMENTS"] = 29)] =
    "SOFTWARE_ENTITLEMENTS";
  EIssueType[(EIssueType["DEPRECATED_APIS"] = 30)] = "DEPRECATED_APIS";
  EIssueType[(EIssueType["MESSAGING_INFRASTRUCTURE_HEALTH"] = 31)] =
    "MESSAGING_INFRASTRUCTURE_HEALTH";
